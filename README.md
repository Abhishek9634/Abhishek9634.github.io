...
1.  **MetaMUI Wallet:** <i>Dec' 23 - Feb' 24</i>

    **Technical Stack:** iOS, SwiftUI, Swift

    **Description:** MetaMUI Wallet: The first asset wallet with identity-based transfers, connecting you to the MetaMUI Blockchain mainnet network.

    **Responsibility:** End-to-end app development on Substrate and Ethereum blockhain.

    [App Store Link](https://apps.apple.com/us/app/metamui-wallet/id1546698261)
    <br/>
    <br/>
